...
import com.danger.common.dao.OpLogDao;
...
public class OpLogService {
    ...
    @Autowired
    private OpLogDao dao;

    @Autowired
    private DaoFacade facade;

    
    public Long insert(OpLogModel e) {
        return dao.insert(e);
    }

    
    public Long insertSelective(OpLogModel e) {
    ...
    public int updateById(OpLogModel e) {
    ...
    public int updateByIdSelective(OpLogModel e) {
    ...
    public OpLogModel getById(Long id) {
        return dao.getById(id);
    }

    
    public List<OpLogModel> getAll() {
        return dao.getAll();
    }

    
    public List<OpLogModel> getList(int page, int pageSize) {
    ...
    public List<OpLogModel> getByIdList(List<Long> ids) {
        return dao.getByIdList(ids);
    }

    
    public List<OpLogModel> selectRaw(String sql, Map<String, Object> map) {
